...
- Remplacement par de vrais sprites : `assets/sprites/pixel/<nom>.png` + le nom listé dans `assets/sprites/pixel/index.json`. Le PNG est repris tel quel, sans traitement, et prend le pas sur l'icône. Fond transparent, pas d'ombre portée (le jeu dessine la sienne), 32×32 recommandé.
