...
CONTENT.biomes.push({
  ...
  trapPool: ['trap_moulin', 'trap_wagonnet', 'trap_embuscade', 'trap_poudre', 'trap_ours', 'trap_dynamite', 'trap_barbeles', 'trap_gatling', 'trap_revolver', 'trap_detente'],
...
CONTENT.traps.push(
  ...
  { id: 'trap_gatling', name: 'Gatling', kind: 'emitter', desc: 'Canon à barillet : 3 bras de balles qui pivotent d\'un huitième de tour à chaque salve.', damage: 11, telegraph: 0.6, period: 2.0, active: 0.3, color: '#ffe08a',
    params: { pattern: 'spiral', count: 3, arc: 6.2832, spin: 0.7854, speed: 250, size: 6, lifetime: 5 } },
  { id: 'trap_revolver', name: 'Revolver', kind: 'emitter', desc: 'Trois coups dans votre direction, tirés coup sur coup en une demi-mesure.', damage: 9, telegraph: 0.7, period: 3.0, active: 0.3, color: '#ffd166',
    params: { pattern: 'aimed', count: 1, arc: 0.5, burst: 3, burstGap: 0.25, speed: 420, size: 5, lifetime: 4 } },
  { id: 'trap_detente', name: 'Fil de détente', kind: 'laser_beam', desc: 'Un fil tendu en travers de la salle, qui claque en rythme. On passe entre deux.', damage: 15, telegraph: 0.6, period: 3.0, active: 1.0, color: '#b0774a',
...
CONTENT.rooms.push(
  ...
  { id: 'room_b3_3', biome: 'biome_3', index: 3, type: 'COMBAT_TRAP', refTime: 105,
    terrain: [
      '........#########.......',
      '.........#######........',
      '..........#####.........',
