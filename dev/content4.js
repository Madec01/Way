...
CONTENT.biomes.push({
  ...
  trapPool: ['trap_sabres', 'trap_brasero', 'trap_meurtriere', 'trap_encens', 'trap_pieux', 'trap_naphte', 'trap_moucharabieh', 'trap_braises', 'trap_derviche', 'trap_rai'],
  miniboss: 'boss_vizir',
...
CONTENT.traps.push(
  ...
  { id: 'trap_braises', name: 'Lanterne à braises', kind: 'emitter', desc: 'Une lanterne suspendue crache une couronne de braises tout autour d\'elle.', damage: 12, telegraph: 0.7, period: 3.0, active: 0.3, color: '#ff9a3c',
    params: { pattern: 'ring', count: 8, arc: 6.2832, speed: 200, size: 7, lifetime: 4 } },
  { id: 'trap_derviche', name: 'Derviche de lames', kind: 'emitter', desc: 'Quatre lames lancées en croix, qui pivotent d\'un seizième de tour à chaque salve.', damage: 11, telegraph: 0.6, period: 2.0, active: 0.3, color: '#d8dce8',
    params: { pattern: 'spiral', count: 4, arc: 6.2832, spin: 0.3927, speed: 240, size: 6, lifetime: 5 } },
  { id: 'trap_rai', name: 'Rai de soleil', kind: 'laser_beam', desc: 'Un rai brûlant traverse la salle depuis la meurtrière, allumé en mesure.', damage: 16, telegraph: 0.6, period: 3.0, active: 1.0, color: '#ffd166',
