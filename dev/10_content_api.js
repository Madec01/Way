...
const LORE = {
  ...
  levelEnter: [
    "Protocole H-9, rév. 3. Conditions d'essai lues. Poursuivez.",
    'Palier ouvert. Neuf cases. Le Bureau observe.',
    "Variable stimulée, variable inhibée. Vous n'êtes pas consulté.",
    'Sujet admis. Le taux de perte est une formalité.',
  ],
  death: [
    'Sujet non conforme. Réimpression programmée.',
    'Données non consignées perdues. Le Site récupère le reste.',
    "Itération close. La matrice retient ce qu'elle peut.",
    'Décès enregistré. Case correspondante : non cochée.',
  ],
  bossWin: [
    'Étalon retiré au seuil critique. Il sera mis à jour.',
    'Confrontation validée. Vos données seront utiles. À lui.',
    "Case 5 cochée. L'Étalon vous remercie pour l'entraînement.",
  ],
  synopsis:
    "Vous êtes un sujet d'essai imprimé pour le Protocole H-9 : neuf salles, un formulaire, une sortie. Le Site vous greffe ce qu'il a sous la main, mesure vos réactions, et rémunère votre consentement. À la case 4, vos données sont consignées. À la case 9, l'Étalon vous attend avec vos propres réponses.",
  fragments: [
    {
      id: 'room3_done',
