...
const UI = (() => {
  ...
  function showHub() {
    ...
    const pb = s.querySelector('#hub-portrait'); const pc = Sprites.portraitBody(cur.sprite || 'player', cur.face ? 1 : 0, 5, cur.face, cur.body, cur.size); if (pc) pb.appendChild(pc);
