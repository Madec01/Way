...
CONTENT.rooms.push(
  ...
  { id: 'room_b2_7', biome: 'biome_2', index: 7, type: 'COMBAT_TEMPO', refTime: 105,
    obstacles: [ { x: 5, y: 3, w: 1, h: 1 }, { x: 18, y: 3, w: 1, h: 1 }, { x: 5, y: 9, w: 1, h: 1 }, { x: 18, y: 9, w: 1, h: 1 } ],
    waves: [
      { at: 'start', spawns: [ { enemy: 'enemy_ronce', count: 3, x: -1, y: -1 }, { enemy: 'enemy_pollinisateur', count: 2, x: -1, y: -1 } ] },
      { at: 'clear', spawns: [ { enemy: 'enemy_spore', count: 3, x: -1, y: -1 }, { enemy: 'enemy_liane', count: 2, x: -1, y: -1 }, { enemy: 'enemy_pollinisateur', count: 2, x: -1, y: -1 }, { enemy: 'enemy_moucherons', count: 1, x: -1, y: -1 } ] },
      { at: 'clear', spawns: [ { enemy: 'enemy_pollinisateur', count: 3, x: -1, y: -1 }, { enemy: 'enemy_ronce', count: 2, x: -1, y: -1 }, { enemy: 'enemy_spore', count: 3, x: -1, y: -1 }, { enemy: 'enemy_liane', count: 1, x: -1, y: -1 }, { enemy: 'enemy_racine', count: 1, x: 21, y: 6 } ] },
    ],
    traps: [
      ...
      { trap: 'trap_dalles', x: 10, y: 5, w: 4, h: 3, params: { beats: { period: 4, active: 0.5, telegraph: 1, on: 1 } } },
      { trap: 'trap_bouche', x: 11, y: 0, params: { dir: 'down', pattern: 'fan', count: 3, beats: { every: 8, telegraph: 1, on: 1 } } },
      { trap: 'trap_bouche', x: 12, y: 12, params: { dir: 'up', pattern: 'fan', count: 3, beats: { every: 8, telegraph: 1, on: 5 } } },
      { trap: 'trap_nappe', x: 4, y: 6, params: { beats: { period: 8, active: 2, telegraph: 2, on: 4 } } },
      { trap: 'trap_nappe', x: 19, y: 6, params: { beats: { period: 8, active: 2, telegraph: 2, on: 0 } } },
      { trap: 'trap_tourelle', x: 0, y: 10, params: { beats: { every: 8, telegraph: 1, on: 3 } } },
      { trap: 'trap_tourelle', x: 23, y: 2, params: { beats: { every: 8, telegraph: 1, on: 7 } } },
    ], fragments: [], modular: [] },
