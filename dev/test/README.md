...
| `pieges` | chantier 13 A : chaque mécanique de piège blesse au point et à l'instant attendus, se recharge, ne fait rien hors fenêtre ni coupée, prévient le bot un quart de seconde avant ; les tireurs lancent leurs balles marquées `trap` aux dégâts du piège sans rejouer un coup ; le ralentissement du gaz lit sa valeur ; la cadence musicale est calculée une fois ; deux pièges identiques ont les mêmes phases ; les dix mécaniques sont des triplets de tables (se rejoue tel quel sur l'ancien moteur) |
