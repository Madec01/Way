const CONTENT = {
  ...
  skills: [
    ...
    { id: 'skill_shield', name: 'Bouclier', desc: 'Bouclier de 55 PV gris pendant 5 s. Cooldown 12 s.',
      cooldown: 12, duration: 5, effect: { kind: 'shield', amount: 55 }, icon: 'shield' },
    { id: 'skill_shockwave', name: 'Onde de choc', desc: 'Repousse, étourdit et inflige 60 dégâts dans 210 px. Cooldown 9 s.',
      cooldown: 9, duration: 0.3, effect: { kind: 'shockwave', radius: 210, damage: 60, knockback: 3 }, icon: 'shockwave' },
  ...
  upgrades: [
    ...
    { id: 'upg_ceinture', name: 'Ceinture d\'astéroïdes', desc: '+3 orbes en orbite, 18 dégâts au contact.', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'orbit_shield', count: 3, damage: 18, radius: 80 }] } },
    ...
    { id: 'upg_foudre_ambiante', name: 'Foudre ambiante', desc: 'Toutes les 2,5 s, la foudre frappe l\'ennemi le plus proche (18 dégâts).', rarity: 'epic', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'lightning_storm', every: 2.5, damage: 18, radius: 320 }] } },
    ...
    { id: 'upg_tempete', name: 'Tempête', desc: 'La foudre frappe toutes les 0,7 s et saute sur 3 ennemis.', rarity: 'colossal', category: 'special', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'lightning_storm', every: 0.7, damage: 26, radius: 380, jumps: 3 }] } },
