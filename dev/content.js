const CONTENT = {
  ...
  upgrades: [
    ...
    { id: 'upg_second_canon', name: 'Second canon', desc: '+1 projectile par tir.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 2, mods: [{ stat: 'projectiles', add: 1 }], hooks: {} },
    { id: 'upg_salve', name: 'Salve', desc: '+2 projectiles par tir, -15 % dégâts.', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [{ stat: 'projectiles', add: 2 }, { stat: 'damage', mul: 0.85 }], hooks: {} },
    { id: 'upg_satellite', name: 'Satellite', desc: 'Un orbe tourne autour de vous : 14 dégâts au contact, bloque les tirs.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 3, mods: [], hooks: { passive: [{ effect: 'orbit_shield', count: 1, damage: 14, radius: 64 }] } },
    ...
    { id: 'upg_foudre_ambiante', name: 'Foudre ambiante', desc: 'Toutes les 2 s, la foudre frappe l\'ennemi le plus proche (22 dégâts).', rarity: 'epic', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'lightning_storm', every: 2, damage: 22, radius: 320 }] } },
    { id: 'upg_aura_brulante', name: 'Aura brûlante', desc: 'Les ennemis à moins de 90 px brûlent : 12 dégâts/s.', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'burn_aura', radius: 90, dps: 12 }] } },
    { id: 'upg_drone', name: 'Drone d\'appoint', desc: 'Un drone vous suit et tire 2 fois/s (8 dégâts).', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 3, mods: [], hooks: { passive: [{ effect: 'drone', count: 1, damage: 8, fireRate: 2, range: 340 }] } },
    ...
    { id: 'upg_munitions', name: 'Munitions', desc: '+10 % dégâts, +8 % cadence.', rarity: 'common', category: 'offense', weaponFamily: null, maxStacks: 4, mods: [{ stat: 'damage', mul: 1.1 }, { stat: 'fireRate', mul: 1.08 }], hooks: {} },
    ...
    { id: 'upg_mitraille', name: 'Mitraille', desc: '+3 projectiles, +25 % cadence, tirs guidés.', rarity: 'colossal', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [{ stat: 'projectiles', add: 3 }, { stat: 'fireRate', mul: 1.25 }], hooks: { passive: [{ effect: 'homing', turn: 3 }] } },
