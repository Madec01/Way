const CONTENT = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      weaponFamily: null,
      maxStacks: 3,
      mods: [{ stat: 'range', mul: 1.15 }],
      hooks: {},
    },
    {
      id: 'upg_calibrage',
      name: 'Calibrage',
      desc: '+20 % vitesse des projectiles.',
      rarity: 'common',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 3,
      mods: [{ stat: 'projSpeed', mul: 1.2 }],
      hooks: {},
    },
    {
      id: 'upg_plaque',
    ...
    {
      id: 'upg_aimant_de_poche',
      name: 'Aimant de poche',
      desc: "+40 px de rayon d'aimantation des pickups.",
      rarity: 'common',
      category: 'mobility',
      weaponFamily: null,
      maxStacks: 3,
      mods: [{ stat: 'pickupRadius', add: 40 }],
      hooks: {},
    },
    {
      id: 'upg_recuperation',
    ...
    },
    {
      id: 'upg_tirelire',
      name: 'Tirelire',
      desc: '+20 % pièces gagnées.',
      rarity: 'common',
      category: 'economy',
      weaponFamily: null,
      maxStacks: 4,
      mods: [{ stat: 'coinGain', mul: 1.2 }],
      hooks: {},
    },
    {
    ...
    },
    {
      id: 'upg_etincelle',
      name: 'Étincelle',
      desc: '15 % de chance de brûler : 5 dégâts/s pendant 2 s.',
      rarity: 'common',
      category: 'special',
      weaponFamily: null,
      maxStacks: 3,
    ...
    },
    {
      ...
      name: 'Chaîne éclair',
      desc: "20 % de chance qu'un coup saute sur 2 ennemis (150 px) à 50 %.",
      rarity: 'rare',
      category: 'special',
      weaponFamily: null,
      maxStacks: 3,
    ...
    },
    {
      ...
      desc: '2 orbes (10 dégâts) tournent à 70 px et bloquent les projectiles.',
      rarity: 'epic',
      category: 'defense',
      weaponFamily: null,
      maxStacks: 1,
    ...
    {
      id: 'upg_balles_incendiaires',
      name: 'Balles incendiaires',
      desc: "35 % de chance d'enflammer : 8 dégâts/s pendant 2,5 s.",
      rarity: 'rare',
      category: 'special',
      weaponFamily: null,
      maxStacks: 2,
      mods: [],
      hooks: { onHit: [{ effect: 'burn', chance: 0.35, dps: 8, duration: 2.5 }] },
    },
    {
      id: 'upg_balles_electriques',
      name: 'Balles électriques',
      desc: "30 % de chance d'électriser : saute sur 2 ennemis (60 % des dégâts).",
      rarity: 'rare',
      category: 'special',
      weaponFamily: null,
      maxStacks: 2,
      mods: [],
      hooks: { onHit: [{ effect: 'chain', chance: 0.3, jumps: 2, radius: 170, damageMul: 0.6 }] },
    },
    {
      id: 'upg_balles_givrantes',
      name: 'Balles givrantes',
      desc: '30 % de chance de geler 1,5 s (vitesse -60 %).',
      rarity: 'rare',
      category: 'special',
      weaponFamily: null,
      maxStacks: 2,
      mods: [],
      hooks: { onHit: [{ effect: 'freeze', chance: 0.3, duration: 1.5, slow: 0.6 }] },
    },
    {
      id: 'upg_second_canon',
      name: 'Second canon',
    ...
    },
    {
      id: 'upg_satellite',
      name: 'Satellite',
      desc: 'Un orbe tourne autour de vous : 10 dégâts au contact, bloque les tirs.',
      rarity: 'rare',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 2,
      mods: [],
      hooks: { passive: [{ effect: 'orbit_shield', count: 1, damage: 10, radius: 64 }] },
    },
    {
      id: 'upg_ceinture',
      name: "Ceinture d'astéroïdes",
      desc: '+3 orbes en orbite, 15 dégâts au contact.',
      rarity: 'epic',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 1,
      mods: [],
      hooks: { passive: [{ effect: 'orbit_shield', count: 3, damage: 15, radius: 80 }] },
    },
    {
      id: 'upg_tir_guide',
      name: 'Tir guidé',
    ...
    {
      id: 'upg_projectiles_lourds',
      name: 'Projectiles lourds',
      desc: "+15 % zone d'effet et recul.",
      rarity: 'common',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 3,
    ...
    },
    {
      id: 'upg_munitions',
      name: 'Munitions',
      desc: '+6 % dégâts, +5 % cadence.',
      rarity: 'common',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 3,
      mods: [
        { stat: 'damage', mul: 1.06 },
        { stat: 'fireRate', mul: 1.05 },
      ],
      hooks: {},
    },
    {
      id: 'upg_conducteur',
      name: 'Conducteur',
      desc: 'Les coups critiques électrisent toujours (3 sauts).',
      rarity: 'epic',
      category: 'special',
      weaponFamily: null,
      maxStacks: 1,
      mods: [{ stat: 'critChance', add: 0.05 }],
      hooks: { onHit: [{ effect: 'chain', chance: 0.45, jumps: 3, radius: 190, damageMul: 0.7 }] },
    },
    {
      id: 'upg_tempete',
      name: 'Tempête',
      desc: 'Toutes les 2,2 s environ, la foudre frappe (48 dégâts) et saute sur 3 ennemis.',
      rarity: 'colossal',
      category: 'special',
      weaponFamily: null,
      maxStacks: 1,
      mods: [],
      hooks: { passive: [{ effect: 'lightning_storm', every: 2.2, damage: 48, radius: 380, jumps: 3 }] },
    },
    {
      id: 'upg_mitraille',
      name: 'Mitraille',
    ...
    },
    {
      id: 'upg_noyau',
      name: 'Noyau',
      desc: '5 orbes en orbite (22 dégâts) et une aura brûlante de 120 px.',
      rarity: 'colossal',
      category: 'offense',
      weaponFamily: null,
      maxStacks: 1,
      ...
      hooks: {
        passive: [
          { effect: 'orbit_shield', count: 5, damage: 22, radius: 96 },
          { effect: 'burn_aura', radius: 120, dps: 16 },
        ],
      },
    },
    {
