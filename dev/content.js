const CONTENT = {
  ...
  characters: [
    {
      ...
      trait: {
        ...
        mods: [{ stat: 'xpGain', mul: 1.15 }, { stat: 'luck', add: 2 }],
  ...
  weapons: [
    {
      ...
      damage: 28, fireRate: 3.4, range: 70, projSpeed: 0, projectiles: 0, spread: 0,
      pierce: 0, bounce: 0, knockback: 1.5, size: 60,
      charge: null,
    ...
    },
    {
      ...
      damage: 75, fireRate: 0.8, range: 95, projSpeed: 0, projectiles: 0, spread: 0,
      pierce: 0, bounce: 0, knockback: 3.0, size: 85,
      charge: null,
  ...
  // =====================================================================
  skills: [
    { id: 'skill_dash', name: 'Dash', desc: 'Ruée de 250 px, invulnérable pendant 0,22 s. Cooldown 5 s.',
      cooldown: 5, duration: 0.22, effect: { kind: 'dash', distance: 250, invulnerable: true }, icon: 'dash' },
    { id: 'skill_shield', name: 'Bouclier', desc: 'Bouclier de 45 PV gris pendant 5 s. Cooldown 12 s.',
      cooldown: 12, duration: 5, effect: { kind: 'shield', amount: 45 }, icon: 'shield' },
    { id: 'skill_shockwave', name: 'Onde de choc', desc: 'Repousse, étourdit et inflige 50 dégâts dans 210 px. Cooldown 9 s.',
      cooldown: 9, duration: 0.3, effect: { kind: 'shockwave', radius: 210, damage: 50, knockback: 3 }, icon: 'shockwave' },
    { id: 'skill_slowtime', name: 'Dilatation', desc: 'Le monde ralentit à 35 % pendant 3,5 s, pas vous. Cooldown 16 s.',
      cooldown: 16, duration: 3.5, effect: { kind: 'slowtime', scale: 0.35, playerScale: 1.0 }, icon: 'slowtime' },
    { id: 'skill_turret', name: 'Tourelle', desc: 'Tourelle : 14 dégâts ×3/s, portée 380 px, 10 s. Cooldown 14 s.',
      cooldown: 14, duration: 10, effect: { kind: 'turret', damage: 14, fireRate: 3, range: 380, hp: 60 }, icon: 'turret' },
    { id: 'skill_blink', name: 'Saut de phase', desc: 'Téléportation de 280 px vers le curseur, 0,25 s invulnérable. CD 7 s.',
      cooldown: 7, duration: 0, effect: { kind: 'blink', distance: 280, invulnerable: 0.25, ignoreObstacles: true }, icon: 'blink' },
    { id: 'skill_magnet', name: 'Aimant', desc: 'Attire tous les pickups de la salle pendant 3 s. Cooldown 10 s.',
      cooldown: 10, duration: 3, effect: { kind: 'magnet', radius: 1400, pullSpeed: 900 }, icon: 'magnet' },
    { id: 'skill_overdrive', name: 'Surrégime', desc: '+60 % dégâts et cadence 6 s, mais 1,5 PV/s perdu. Cooldown 16 s.',
      cooldown: 16, duration: 6, effect: { kind: 'overdrive', damageMul: 1.6, fireRateMul: 1.6, selfDamagePerSec: 1.5 }, icon: 'overdrive' }
  ],
  ...
  upgrades: [
    // ---- COMMUNES (20) ----
    { id: 'upg_tranchant', name: 'Tranchant', desc: '+10 % dégâts.', rarity: 'common', category: 'offense', weaponFamily: null, maxStacks: 5,
      mods: [{ stat: 'damage', mul: 1.10 }], hooks: {} },
    { id: 'upg_gachette', name: 'Gâchette', desc: '+8 % cadence d\'attaque.', rarity: 'common', category: 'offense', weaponFamily: null, maxStacks: 4,
      mods: [{ stat: 'fireRate', mul: 1.08 }], hooks: {} },
    ...
    // ---- RARES (15) ----
    { id: 'upg_frappe_lourde', name: 'Frappe lourde', desc: '+22 % dégâts, -8 % cadence.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 3,
      mods: [{ stat: 'damage', mul: 1.22 }, { stat: 'fireRate', mul: 0.92 }], hooks: {} },
    { id: 'upg_double_canon', name: 'Double canon', desc: '+1 projectile, -25 % dégâts.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 2,
      mods: [{ stat: 'projectiles', add: 1 }, { stat: 'damage', mul: 0.75 }], hooks: {} },
    ...
    { id: 'upg_orbes_gardiennes', name: 'Orbes gardiennes', desc: '2 orbes (10 dégâts) tournent à 70 px et bloquent les projectiles.', rarity: 'epic', category: 'defense', weaponFamily: null, maxStacks: 1,
    ...
    { id: 'upg_balles_incendiaires', name: 'Balles incendiaires', desc: '35 % de chance d\'enflammer : 8 dégâts/s pendant 2,5 s.', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { onHit: [{ effect: 'burn', chance: 0.35, dps: 8, duration: 2.5 }] } },
    { id: 'upg_balles_electriques', name: 'Balles électriques', desc: '30 % de chance d\'électriser : saute sur 2 ennemis (60 % des dégâts).', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { onHit: [{ effect: 'chain', chance: 0.3, jumps: 2, radius: 170, damageMul: 0.6 }] } },
    { id: 'upg_balles_givrantes', name: 'Balles givrantes', desc: '30 % de chance de geler 1,5 s (vitesse -60 %).', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { onHit: [{ effect: 'freeze', chance: 0.3, duration: 1.5, slow: 0.6 }] } },
    { id: 'upg_second_canon', name: 'Second canon', desc: '+1 projectile par tir, -12 % dégâts.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 2, mods: [{ stat: 'projectiles', add: 1 }, { stat: 'damage', mul: 0.88 }], hooks: {} },
    { id: 'upg_salve', name: 'Salve', desc: '+2 projectiles par tir, -30 % dégâts.', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [{ stat: 'projectiles', add: 2 }, { stat: 'damage', mul: 0.7 }], hooks: {} },
    { id: 'upg_satellite', name: 'Satellite', desc: 'Un orbe tourne autour de vous : 10 dégâts au contact, bloque les tirs.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'orbit_shield', count: 1, damage: 10, radius: 64 }] } },
    { id: 'upg_ceinture', name: 'Ceinture d\'astéroïdes', desc: '+3 orbes en orbite, 15 dégâts au contact.', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'orbit_shield', count: 3, damage: 15, radius: 80 }] } },
    { id: 'upg_tir_guide', name: 'Tir guidé', desc: 'Vos projectiles se dirigent vers l\'ennemi le plus proche.', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'homing', turn: 2.5 }] } },
    { id: 'upg_eclats', name: 'Éclats', desc: 'Chaque impact libère 2 éclats (40 % des dégâts).', rarity: 'epic', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { onHit: [{ effect: 'split_on_hit', chance: 1, count: 2, damageMul: 0.4 }] } },
    { id: 'upg_tir_arriere', name: 'Tir arrière', desc: 'Chaque tir envoie aussi un projectile derrière vous (50 %).', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'rear_shot', damageMul: 0.5 }] } },
    { id: 'upg_balles_explosives', name: 'Balles explosives', desc: '25 % de chance qu\'un impact explose (60 px, 70 % des dégâts).', rarity: 'epic', category: 'special', weaponFamily: null, maxStacks: 1, mods: [], hooks: { onHit: [{ effect: 'hit_explode', chance: 0.25, radius: 60, damageMul: 0.7 }] } },
    { id: 'upg_foudre_ambiante', name: 'Foudre ambiante', desc: 'Toutes les 3,5 s environ, la foudre frappe l\'ennemi le plus proche (26 dégâts).', rarity: 'epic', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'lightning_storm', every: 3.5, damage: 26, radius: 320 }] } },
    { id: 'upg_aura_brulante', name: 'Aura brûlante', desc: 'Les ennemis à moins de 90 px brûlent : 8 dégâts/s.', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'burn_aura', radius: 90, dps: 8 }] } },
    { id: 'upg_drone', name: 'Drone d\'appoint', desc: 'Un drone vous suit et tire 2 fois/s (6 dégâts).', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 2, mods: [], hooks: { passive: [{ effect: 'drone', count: 1, damage: 6, fireRate: 2, range: 340 }] } },
    { id: 'upg_execution', name: 'Exécution', desc: 'Les ennemis (hors boss) sous 15 % de PV meurent au prochain coup.', rarity: 'rare', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'execute', threshold: 0.15 }] } },
    { id: 'upg_gel_profond', name: 'Gel profond', desc: 'Les ennemis gelés subissent +35 % de dégâts.', rarity: 'rare', category: 'special', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'frost_bonus', mul: 1.35 }] } },
    { id: 'upg_rafale', name: 'Rafale', desc: 'Après une compétence : cadence +45 % pendant 3 s.', rarity: 'rare', category: 'mobility', weaponFamily: null, maxStacks: 1, mods: [], hooks: { onSkill: [{ effect: 'fire_frenzy', fireRateMul: 1.45, duration: 3 }] } },
    { id: 'upg_projectiles_lourds', name: 'Projectiles lourds', desc: '+15 % zone d\'effet et recul.', rarity: 'common', category: 'offense', weaponFamily: null, maxStacks: 3, mods: [{ stat: 'areaSize', mul: 1.15 }, { stat: 'knockback', mul: 1.2 }], hooks: {} },
    { id: 'upg_munitions', name: 'Munitions', desc: '+6 % dégâts, +5 % cadence.', rarity: 'common', category: 'offense', weaponFamily: null, maxStacks: 3, mods: [{ stat: 'damage', mul: 1.06 }, { stat: 'fireRate', mul: 1.05 }], hooks: {} },
    { id: 'upg_conducteur', name: 'Conducteur', desc: 'Les coups critiques électrisent toujours (3 sauts).', rarity: 'epic', category: 'special', weaponFamily: null, maxStacks: 1, mods: [{ stat: 'critChance', add: 0.05 }], hooks: { onHit: [{ effect: 'chain', chance: 0.45, jumps: 3, radius: 190, damageMul: 0.7 }] } },
    { id: 'upg_tempete', name: 'Tempête', desc: 'Toutes les 2,2 s environ, la foudre frappe (48 dégâts) et saute sur 3 ennemis.', rarity: 'colossal', category: 'special', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'lightning_storm', every: 2.2, damage: 48, radius: 380, jumps: 3 }] } },
    { id: 'upg_mitraille', name: 'Mitraille', desc: '+3 projectiles, tirs guidés, -20 % dégâts.', rarity: 'colossal', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [{ stat: 'projectiles', add: 3 }, { stat: 'damage', mul: 0.8 }], hooks: { passive: [{ effect: 'homing', turn: 3 }] } },
    { id: 'upg_noyau', name: 'Noyau', desc: '5 orbes en orbite (22 dégâts) et une aura brûlante de 120 px.', rarity: 'colossal', category: 'offense', weaponFamily: null, maxStacks: 1, mods: [], hooks: { passive: [{ effect: 'orbit_shield', count: 5, damage: 22, radius: 96 }, { effect: 'burn_aura', radius: 120, dps: 16 }] } },
  ...
  enemies: [
    { id: 'enemy_rodeur', name: 'Rôdeur', archetype: 'rusher',
      ...
      hp: 43, speed: 200, damage: 9, radius: 14, xp: 4, coins: 1, color: '#e05a4a',
    ...
    { id: 'enemy_sentinelle', name: 'Sentinelle', archetype: 'shooter',
      ...
      hp: 36, speed: 130, damage: 9, radius: 14, xp: 6, coins: 2, color: '#4fa3e0',
    ...
    { id: 'enemy_bloc', name: 'Bloc', archetype: 'tank',
      ...
      hp: 200, speed: 90, damage: 12, radius: 24, xp: 14, coins: 4, color: '#8c6d4f',
    ...
    { id: 'enemy_meche', name: 'Mèche', archetype: 'kamikaze',
      ...
      hp: 25, speed: 240, damage: 6, radius: 12, xp: 5, coins: 1, color: '#ff5f3b',
    ...
    { id: 'enemy_incubateur', name: 'Incubateur', archetype: 'summoner',
      ...
      hp: 90, speed: 60, damage: 9, radius: 20, xp: 20, coins: 5, color: '#9b6fd6',
    ...
    { id: 'enemy_nuee', name: 'Nuée', archetype: 'swarm',
      ...
      hp: 11, speed: 300, damage: 5, radius: 8, xp: 3, coins: 1, color: '#7ed957',
    ...
    { id: 'enemy_eclipse', name: 'Éclipse', archetype: 'dasher',
      ...
      hp: 45, speed: 180, damage: 13, radius: 14, xp: 10, coins: 3, color: '#d64fbf',
  ...
  bosses: [
    {
      ...
      revenge: {
        hpMul: 0.9, plateHits: 5, window: 0.4, wallStun: 0.6, name: 'Étalon 07 / rév. B', phaseText: 'DONNÉES CHARGÉES', mimic: true,
        extraPhases: [
  ...
  petsExemples: [
    ...
    { id: 'pet_chien', name: 'Chien de garde', sprite: 'sniffing-dog', color: '#d8b46a', tag: 'mord et attire les coups',
      ...
      behavior: 'bite', damage: 14, every: 4, range: 280, speed: 320, knockback: 2, taunt: 230, hp: 90, revive: 6, size: 34, price: 240 },
    { id: 'pet_serpent', name: 'Serpent cracheur', sprite: 'snake', color: '#9ade6a', tag: 'crache sur chaque temps',
      ...
      behavior: 'spit', damage: 9, every: 2, range: 340, speed: 250, projSpeed: 480, projSize: 5, size: 30, price: 220 },
    { id: 'pet_scarabee', name: 'Scarabée fouineur', sprite: 'scarab-beetle', color: '#c9a3ff', tag: 'ramasse à votre place',
      ...
      behavior: 'collect', damage: 0, every: 4, radius: 260, speed: 280, size: 28, price: 120, unlocked: true },
    { id: 'pet_tortue', name: 'Tortue bouclier', sprite: 'turtle', color: '#6ee7ff', tag: 'brise 2 tirs par temps',
      ...
      behavior: 'guard', damage: 0, every: 1, block: 2, dist: 56, spin: 1.7, size: 30, price: 280 },
    { id: 'pet_crapaud', name: 'Crapaud guérisseur', sprite: 'frog', color: '#7fff9a', tag: 'soigne sur le temps fort',
      ...
      behavior: 'mend', damage: 0, every: 4, heal: 4, speed: 230, size: 30, price: 300 },
    { id: 'pet_tatou', name: 'Tatou blindé', sprite: 'armadillo', color: '#b0a08a', tag: 'traverse la salle sur le temps fort',
      desc: 'Il se met en boule et traverse la salle en ligne droite à chaque temps fort, bousculant tout sur son passage.',
      behavior: 'charge', damage: 18, every: 4, range: 420, speed: 240, rollSpeed: 560, rollTime: 0.8, knockback: 3, size: 32, price: 260 },
    { id: 'pet_chouette', name: 'Chouette guetteuse', sprite: 'owl', color: '#d8c9a0', tag: 'désigne une cible à chaque mesure',
      desc: 'Elle désigne un ennemi à chaque mesure : il encaisse 30 % de dégâts en plus tant qu\'il est marqué.',
      behavior: 'mark', fly: true, damage: 0, every: 4, range: 420, markTime: 4, markMul: 1.3, speed: 280, size: 30, price: 320 },
    { id: 'pet_abeille', name: 'Abeille', sprite: 'bee', color: '#ffd166', tag: 'pique sur chaque temps',
  ...
  traps: [
    { id: 'trap_balayage', name: 'Balayage laser', kind: 'laser_sweep',
      ...
      damage: 15, telegraph: 0.8, period: 5.0, active: 1.6,
    ...
    { id: 'trap_tourniquet', name: 'Tourniquet', kind: 'laser_rotate',
      ...
      damage: 13, telegraph: 1.0, period: 6.0, active: 5.0,
    ...
    { id: 'trap_grille', name: 'Grille', kind: 'laser_grid',
      ...
      damage: 11, telegraph: 0.5, period: 3.0, active: 1.0,
    ...
    { id: 'trap_bouche', name: 'Bouche de feu', kind: 'wall_fireball',
      ...
      damage: 13, telegraph: 0.6, period: 2.5, active: 0.2,
    ...
    { id: 'trap_dalles', name: 'Dalles à pointes', kind: 'spike_tiles',
      ...
      damage: 11, telegraph: 0.5, period: 2.6, active: 0.8,
    ...
    { id: 'trap_nappe', name: 'Nappe de gaz', kind: 'gas_zone',
      ...
      damage: 9, telegraph: 1.2, period: 7.0, active: 3.0,
