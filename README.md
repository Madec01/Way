...
Un roguelite d'action 2D vue de dessus, dans le navigateur. Quatre niveaux : ADMISSION, LA SERRE (débloquée après la salle 9 d'ADMISSION), LA CONCESSION, un western minier (débloqué après LA SERRE), et LE SÉRAIL, un palais oriental enseveli (débloqué après LA CONCESSION), 9 salles chacun (préparation, pièges, combats, coffres, mini-boss, salles modulaires, boss revanche), en un seul fichier `index.html` (Canvas 2D, JS vanilla, Web Audio, localStorage) + un dossier `assets/` (sprites CC0, vos musiques).
