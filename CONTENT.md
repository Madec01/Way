...
Test : `perf.js` — 11 mesures (Halo.line/rect, plus de shadowBlur dans les rendus des pièges, modules, tempo, porte et lames, au plus 5 flous par image en salles 2/6/7/8, la mesure qui vit et sa ligne dans le rapport, le rendu économe qui coupe et se remet, l'automatique au tactile après 3 s lentes et jamais au clavier, la pause, le compteur dessiné, les boutons tactiles sans flou, `?perf`).
