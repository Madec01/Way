...
| Pièges progressifs | Les pièges arrivent par familles, dans l'ordre où la salle les déclare : une seule famille au « GO », une de plus à chaque vague, annoncée par un bandeau « Nouveau piège : … ». On entre donc sur un seul type de piège et on finit avec tous. |
